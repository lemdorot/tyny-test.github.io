(() => {
    ...
    const script_form = document.querySelector(".message__form");
    const nameInput = script_form.querySelector(".message__name");
    const emailInput = script_form.querySelector(".message__email");
    const messageInput = script_form.querySelector(".message__textarea");
    script_form.addEventListener("submit", (evt => {
        evt.preventDefault();
